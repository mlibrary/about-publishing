...
(function ($) {
	...
	AblePlayer.prototype.setButtonImages = function() {
		...
		this.signButtonImg = this.imgPath + 'slides.png';
	...
	AblePlayer.prototype.getSvgData = function(button) {
		...
		switch (button) {
            ...
            case 'sign':
                svg[0] = '0 0 21.3 20.34';
                svg[1] = 'M20.24.51H3.76c-.82,0-1.64,0-2.46,0A2.25,2.25,0,0,0,.5.87V2.63a1,1,0,0,0,1,.52h0v12l.78.77h7.92L6.78,19.3l.15.36c1.21-.54,1.72-1.92,3.05-2.47l.13,2.47.56-.18a9.3,9.3,0,0,1,.2-2.36c1.11.79,1.81,1.83,2.76,2.53L14,19.4s0-.13,0-.16c-1-1.11-2.08-2.21-3.14-3.34H19l.81-.83V3.24l1-.85C20.72,1.65,21,.94,20.24.51Zm-.5,1.91H1.87l-1-.5.66-.73H19.66l.53.56Z';
                break;
