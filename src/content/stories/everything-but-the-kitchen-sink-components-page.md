...
<figure class="advanced-image md:float-left md:mr-8 mb-4 -ml-32"><img src="/assets/so-s-18-biology-benzie-p-2-104.jpg" alt="jellyfish"><figcaption class="text-xs text-slate-grey mt-2">Nullam quis risus eget urna mollis ornare vel eu leo.<p class="text-xs mb-2">Julian Rothschild, AP Photo</p><div class="w-40 h-1 bg-michigan-blue"></div></figcaption></figure>
